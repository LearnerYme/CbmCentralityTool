...
namespace cent_conf {
    ...
    static int cent_edge[5] = { // here fill in the centrality bin edge 
        129, 90, 62, 41, 26
    };
    // with RefMult3M
    static int cent_edgeM[5] = { // here fill in the centrality bin edge
        261, 182, 125, 83, 53 
    };
    // <Npart> with RefMult3
    static double nPart_edge[5] = {
        310.033, 225.096, 161.604, 112.748, 75.4538
    };
    // <Npart> with RefMult3M
    static double nPart_edgeM[5] = {
